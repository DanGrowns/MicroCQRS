...
namespace View
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSingleton<IDbConnector, SqliteConnector>();
            
            services.AddTransient<IProjectDbContext, ProjectDbContext>();
            services.AddTransient<IEntityFrameworkModelDeleter, EntityFrameworkModelDeleter>();
            
            services.ConfigureCqrsObjects(typeof(IProjectDbContext));
        }
